...
public class TargetUpperConeNodeCommand extends CommandBase {
   ...
   */
  public TargetUpperConeNodeCommand(DriveSubsystem driveSubsystem) {
  ...
  public void initialize() {
    LimelightHelpers.setPipelineIndex("limelight",LLConstants.kUpperConePipeline);
  }
